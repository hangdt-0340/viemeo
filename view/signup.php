    ...
    <form action="register.php" method="post" name="registerForm">
        ...
        <div class="container align-center">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <input type="text" name="username" class="username border">
                </div>
            </div>
        </div>
        <div class="container align-center">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <input type="email" name="email" class="email border">
                </div>
            </div>
        </div>
        <div class="container align-center">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <input type="password" name="password" class="password border">
                </div>
            </div>
        </div>
        <div class="container align-center" style="margin-bottom: 3%;">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <input type="password" name="confirm_password" class="password border">
                </div>
            </div>
        </div>
        <div class="container align-center" style="margin-bottom: 5%;">
            ...
            <div class="action-button">
                <button class="start-with-sutdio-btn-log" data-cy="home-start-editing-button">Register
                ...
                <div class="home-signin"><a href="../view/signin.php">You have account, SignIn</a></div>
            </div>
            </div>
        </div>
    </form>
